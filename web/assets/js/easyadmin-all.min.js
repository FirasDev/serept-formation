!function (e, t) {
    ...
    function p(e, t, n, r, i) {
        for (var o, s, a, u, l, p, d = t.createDocumentFragment(), h = [], g = 0, v = e.length; v > g; g++) if (o = e[g], o || 0 === o) if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o); else if (Re.test(o)) {
    ...
    function v(e, t, n, r, i, o) {
        ...
        if (null == r && null == i ? (i = n, r = n = void 0) : null == i && ("string" == typeof n ? (i = r, r = void 0) : (i = r, r = n, n = void 0)), i === !1) i = h; else if (!i) return this;
    ...
    function T(e, t, n, r) {
        ...
        if (d && (i = p(t, e[0].ownerDocument, !1, e, r), o = i.firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            ...
            if (a) for (l = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; a > f; f++) u = s[f], Fe.test(u.type || "") && !Ee.access(u, "globalEval") && oe.contains(l, u) && (u.src ? oe._evalUrl && oe._evalUrl(u.src) : oe.globalEval(u.textContent.replace(ze, "")))
        }
        return e
    }
    ...
    function P(e, t, n) {
        for (var r, i = (W.tweeners[t] || []).concat(W.tweeners["*"]), o = 0, s = i.length; s > o; o++) if (r = i[o].call(n, t, e)) return r
    }
    ...
    function W(e, t, n) {
        var r, i, o = 0, s = W.prefilters.length, a = oe.Deferred().always(function () {
            delete u.elem
        }), u = function () {
            if (i) return !1;
    ...
    var Y = [], G = e.document, Q = Y.slice, J = Y.concat, K = Y.push, Z = Y.indexOf, ee = {}, te = ee.toString,
        ne = ee.hasOwnProperty, re = {}, ie = "2.2.0", oe = function (e, t) {
    ...
    var ce = function (e) {
        ...
        function x(e, n) {
            var i = n.length > 0, o = e.length > 0, s = function (r, s, a, u, l) {
                ...
                for (l && (D = s === q || s || l); h !== w && null != (c = x[h]); h++) {
                    if (o && c) {
                        for (f = 0, s || c.ownerDocument === q || (L(c), a = !O); p = e[f++];) if (p(c, s || q, a)) {
                            u.push(c);
                            break
                        }
                        l && ($ = b)
        ...
        var b, w, T, C, k, E, N, S, D, j, A, L, q, H, O, F, P, R, M, W = "sizzle" + 1 * new Date, I = e.document, $ = 0,
                    ...
                    return 1 === r && 0 === i ? function (e) {
                        ...
                        if (v) {
                            ...
                            if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                for (p = v, f = p[W] || (p[W] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === $ && l[1], x = d && l[2], p = d && v.childNodes[d]; p = ++d && p && p[g] || (x = d = 0) || h.pop();) if (1 === p.nodeType && ++x && p === t) {
                                    c[e] = [$, d, x];
                                    break
                                }
                            } else if (y && (p = t, f = p[W] || (p[W] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), l = c[e] || [], d = l[0] === $ && l[1], x = d), x === !1) for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((a ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++x || (y && (f = p[W] || (p[W] = {}), c = f[p.uniqueID] || (f[p.uniqueID] = {}), c[e] = [$, x]), p !== t));) ;
    ...
    oe.event = {
        ...
        remove: function (e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
                for (t = (t || "").match(we) || [""], l = t.length; l--;) if (a = Ie.exec(t[l]) || [], d = g = a[1], h = (a[2] || "").split(".").sort(), d) {
    ...
    oe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e) for (t = e.match(we) || []; n = this[u++];) if (i = I(n), r = 1 === n.nodeType && (" " + i + " ").replace(pt, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function (n) {
                ...
                var t, r, i, o;
                if ("string" === n) for (r = 0, i = oe(this), o = e.match(we) || []; t = o[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else (void 0 === e || "boolean" === n) && (t = I(this), t && Ee.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : Ee.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, r = 0;
    ...
    var yt = /#.*$/, xt = /([?&])_=[^&]*/, bt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        ...
        Et = {}, Nt = "*/".concat("*"), St = G.createElement("a");
    St.href = gt.href, oe.extend({
        ...
        ajax: function (t, n) {
            ...
            c = oe.event && p.global, c && 0 === oe.active++ && oe.event.trigger("ajaxStart"), p.type = p.type.toUpperCase(), p.hasContent = !Tt.test(p.type), o = p.url, p.hasContent || (p.data && (o = p.url += (mt.test(o) ? "&" : "?") + p.data, delete p.data), p.cache === !1 && (p.url = xt.test(o) ? o.replace(xt, "$1_=" + vt++) : o + (mt.test(o) ? "&" : "?") + "_=" + vt++)), p.ifModified && (oe.lastModified[o] && T.setRequestHeader("If-Modified-Since", oe.lastModified[o]), oe.etag[o] && T.setRequestHeader("If-None-Match", oe.etag[o])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && T.setRequestHeader("Content-Type", p.contentType), T.setRequestHeader("Accept", p.dataTypes[0] && p.accepts[p.dataTypes[0]] ? p.accepts[p.dataTypes[0]] + ("*" !== p.dataTypes[0] ? ", " + Nt + "; q=0.01" : "") : p.accepts["*"]);
    ...
    oe.ajaxSetup({
        ...
        var i, o, s,
            a = t.jsonp !== !1 && (Pt.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && Pt.test(t.data) && "data");
        return a || "jsonp" === t.dataTypes[0] ? (i = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(Pt, "$1" + i) : t.jsonp !== !1 && (t.url += (mt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i), t.converters["script json"] = function () {
            ...
            return this.each(function () {
                function o(t) {
                    if (h) {
                        ...
                        e(o).closest("." + a.wrapperClass).is(E.parent()) && r(i, !0), t.preventDefault && !y && t.preventDefault(), y || (t.returnValue = !1)
                    }
                }

                function r(e, t, i) {
                    y = !1;
                    var o = e, r = E.outerHeight() - T.outerHeight();
                    if (t && (o = parseInt(T.css("top")) + e * parseInt(a.wheelStep) / 100 * T.outerHeight(), o = Math.min(Math.max(o, 0), r), o = e > 0 ? Math.ceil(o) : Math.floor(o), T.css({top: o + "px"})), v = parseInt(T.css("top")) / (E.outerHeight() - T.outerHeight()), o = v * (E[0].scrollHeight - E.outerHeight()), i) {
                        o = e;
                        var s = o / E[0].scrollHeight * E.outerHeight();
                        s = Math.min(Math.max(s, 0), r), T.css({top: s + "px"})
                    }
                    E.scrollTop(o), E.trigger("slimscrolling", ~~o), l(), c()
                }
                ...
                function n() {
                    f = Math.max(E.outerHeight() / E[0].scrollHeight * E.outerHeight(), m), T.css({height: f + "px"});
                    var e = f == E.outerHeight() ? "none" : "block";
                    T.css({display: e})
                }
                ...
                function l() {
                    ...
                    return b = v, f >= E.outerHeight() ? void(y = !0) : (T.stop(!0, !0).fadeIn("fast"), void(a.railVisible && H.stop(!0, !0).fadeIn("fast")))
                }

                function c() {
                    a.alwaysVisible || (p = setTimeout(function () {
                        a.disableFadeOut && h || u || d || (T.fadeOut("slow"), H.fadeOut("slow"))
                    }, 1e3))
                }

                var h, u, d, p, g, f, v, b, w = "<div></div>", m = 30, y = !1, E = e(this);
                if (E.parent().hasClass(a.wrapperClass)) {
                    var S = E.scrollTop();
                    if (T = E.parent().find("." + a.barClass), H = E.parent().find("." + a.railClass), n(), e.isPlainObject(i)) {
                        if ("height" in i && "auto" == i.height) {
                            E.parent().css("height", "auto"), E.css("height", "auto");
                            var x = E.parent().parent().height();
                            E.parent().css("height", x), E.css("height", x)
                        }
                        if ("scrollTo" in i) S = parseInt(a.scrollTo); else if ("scrollBy" in i) S += parseInt(a.scrollBy); else if ("destroy" in i) return T.remove(), H.remove(), void E.unwrap();
                        r(S, !1, !0)
                    }
                } else if (!(e.isPlainObject(i) && "destroy" in i)) {
                    a.height = "auto" == a.height ? E.parent().height() : a.height;
                    ...
                    E.css({overflow: "hidden", width: a.width, height: a.height, "-ms-touch-action": "none"});
                    var H = e(w).addClass(a.railClass).css({
                        ...
                        zIndex: 99
                    }), M = "right" == a.position ? {right: a.distance} : {left: a.distance};
                    H.css(M), T.css(M), E.wrap(C), E.parent().append(T), E.parent().append(H), a.railDraggable && T.bind("mousedown", function (i) {
                        var o = e(document);
                        return d = !0, t = parseFloat(T.css("top")), pageY = i.pageY, o.bind("mousemove.slimscroll", function (e) {
                            currTop = t + e.pageY - pageY, T.css("top", currTop), r(0, T.position().top, !1)
                        ...
                        h = !1, c()
                    }), window.navigator.msPointerEnabled ? (E.bind("MSPointerDown", function (e, t) {
                        e.originalEvent.targetTouches.length && (g = e.originalEvent.targetTouches[0].pageY)
                    }), E.bind("MSPointerMove", function (e) {
                        if (e.originalEvent.preventDefault(), e.originalEvent.targetTouches.length) {
                            var t = (g - e.originalEvent.targetTouches[0].pageY) / a.touchScrollStep;
                            r(t, !0), g = e.originalEvent.targetTouches[0].pageY
                        }
                    ...
                    })), n(), "bottom" === a.start ? (T.css({top: E.outerHeight() - T.outerHeight()}), r(0, !0)) : "top" !== a.start && (r(e(a.start).position().top, null, !0), a.alwaysVisible || T.hide()), s()
                }
            }), this
        }
...
function _init() {
    ...
    $.AdminLTE.layout = {
        activate: function () {
            ...
            var e = $(".main-header").outerHeight() + $(".main-footer").outerHeight(), i = $(window).height(),
                o = $(".sidebar").height();
            if ($("body").hasClass("fixed")) $(".content-wrapper, .right-side").css("min-height", i - $(".main-footer").outerHeight()); else {
                var n;
                ...
                "undefined" != typeof t && t.height() > n && $(".content-wrapper, .right-side").css("min-height", t.height())
            }
        }, fixSidebar: function () {
        ...
        activate: function (e) {
            ...
            var e = this, i = $.AdminLTE.options.screenSizes.sm - 1;
        ...
        var i = this, o = $.AdminLTE.options.animationSpeed;
        $(document).on("click", e + " li a", function (e) {
            ...
            }), t.parent("li").removeClass("active"); else if (t.is(".treeview-menu") && !t.is(":visible")) {
                var s = n.parents("ul").first(), a = s.find("ul:visible").slideUp(o);
        ...
        activate: function () {
            var e = this, i = $.AdminLTE.options.controlSidebarOptions, o = $(i.selector), n = $(i.toggleBtnSelector);
            ...
            e._fix(t), $("body").hasClass("fixed") ? e._fixForFixed(o) : $(".content-wrapper, .right-side").height() < o.height() && e._fixForContent(o)
        }, open: function (e, i) {
            ...
            $("body").hasClass("layout-boxed") ? (e.css("position", "absolute"), e.height($(".wrapper").height()), $(window).resize(function () {
                i._fix(e)
            })) : e.css({position: "fixed", height: "auto"})
        ...
        collapse: function (e) {
            var i = this, o = e.parents(".box").first(),
        ...
        remove: function (e) {
            var i = e.parents(".box").first();
            i.slideUp(this.animationSpeed)
        }
    }
}
...
$.AdminLTE = {}, $.AdminLTE.options = {
    ...
    e.fn.boxRefresh = function (i) {
        ...
        }, i), s = e('<div class="overlay"><div class="fa fa-refresh fa-spin"></div></div>');
        return this.each(function () {
    ...
    e.fn.todolist = function (i) {
        ...
        return this.each(function () {
            "undefined" != typeof e.fn.iCheck ? (e("input", this).on("ifChecked", function () {
...
!function (e) {
    ...
    t.prototype = {
        ...
        setup: function (t, n) {
            ...
            var r = e.extend(this, n, {target: t}), o = r.resetCss ? r.namespace + "-reset" : r.namespace,
        ...
        contentFilters: {
            jquery: {
                ...
                regex: /\.(png|jpg|jpeg|gif|tiff|bmp|svg)(\?\S*)?$/i, process: function (t) {
                    var n = this, r = e.Deferred(), o = new Image,
        ...
        readElementConfig: function (t, n) {
            ...
            return t && t.attributes && e.each(t.attributes, function () {
                ...
                if (t) {
                    ...
                    if (e.inArray(a, r.functionAttributes) >= 0) n = new Function(n); else try {
                        n = e.parseJSON(n)
                    } catch (s) {
                    }
                    i[a] = n
        ...
        attach: function (t, n, r) {
            ...
            return t.on(s.openTrigger + "." + s.namespace, s.filter, function (a) {
                var c = e.extend({
                    ...
                    l = i || e(this).data("featherlight-persisted") || new o(n, c);
                "shared" === l.persist ? i = l : l.persist !== !1 && e(this).data("featherlight-persisted", l), c.$currentTarget.blur(), l.open(a)
            }), t
        },
        current: function () {
            var e = this.opened();
        ...
        var t = e.extend({
            ...
            switch (i.is("select") && (r = "select"), r) {
                ...
                case"radio":
                    ...
                    break;
                case"select":
                    t = "", i.find("option").each(function (i) {
                        var r = e(this);
            ...
            e(r).each(function () {
                n(e(this))
            }), e(r).unbind(t.fieldEvents, a), e(r).bind(t.fieldEvents, a), i.data("ays-orig-field-count", e(r).length), o(i, !1)
        }, o = function (e, i) {
            var r = i != e.hasClass(t.dirtyClass);
            e.toggleClass(t.dirtyClass, i), r && (t.change && t.change.call(e, e), i && e.trigger("dirty.areYouSure", [e]), i || e.trigger("clean.areYouSure", [e]), e.trigger("change.areYouSure", [e]))
        }, d = function () {
            var i = e(this), r = i.find(t.fieldSelector);
            e(r).each(function () {
                var i = e(this);
        ...
        return t.silent || window.aysUnloadSet || (window.aysUnloadSet = !0, e(window).bind("beforeunload", function () {
            ...
            if (e(this).is("form")) {
                ...
                r.submit(function () {
                    ...
                    o(r, !1)
                }), r.bind("rescan.areYouSure", d), r.bind("reinitialize.areYouSure", u), r.bind("checkform.areYouSure", a), s(r)
            }
        })
    }
}(jQuery);
    ...
    e.prototype.add = function (t) {
        ...
        for (var r in t) {
            ...
            for (var a in this.waypoints[r]) {
                var l, h, p, c, u, d = this.waypoints[r][a], f = d.options.offset, w = d.triggerPoint, y = 0,
                    g = null == w;
...
!function (t, e, i, n) {
    ...
    function s(e, i) {
        this.element = e, this.settings = t.extend({}, a), this._defaults = a, this._name = o, this.init()
    }

    var o = "easyAdminSticky",
        a = {stickyClass: "stuck", placeholderClass: "sticky-wrapper", sidebarDuration: 300, bottomOffset: 15};
    t.extend(s.prototype, {
        init: function () {
            this._createPlaceholder(), this._initWaypoint(), this._bindWindowResizeEvent(), this._bindAdminLteSidebarEvents(), this._bindCkEditorEvent()
        }, _createPlaceholder: function () {
            this.$placeholder = t("<div>").attr("class", t(this.element).attr("class")).removeClass(this.settings.stickyClass).addClass(this.settings.placeholderClass).insertAfter(this.element)
        }, _initWaypoint: function () {
            var i = this;
            this.waypoint = new Waypoint({
                element: i.$placeholder[0], offset: function () {
                    return this.context.innerHeight() - this.adapter.outerHeight() + i.settings.bottomOffset
                }, handler: function (e) {
                    var n = t(i.element);
                    i.$placeholder.height(0), n.removeClass(i.settings.stickyClass).css("width", "100%"), "up" === e && i._createStickyFooter()
                }
            }), t(e).height() > i.waypoint.triggerPoint && i._createStickyFooter()
        }, _bindAdminLteSidebarEvents: function () {
            var e = this;
            t(i).on("collapsed.pushMenu expanded.pushMenu", function () {
                setTimeout(function () {
                    e._refreshWaypointAndWidth()
                }, e.settings.sidebarDuration)
            })
            ...
            t(e).on("resize", function () {
                var t = function () {
                    setTimeout(function () {
                        i._refreshWaypointAndWidth()
                    }, i.settings.sidebarDuration)
                };
                i._debounce(t(), 250)
            })
            ...
            if ("undefined" != typeof CKEDITOR) {
                ...
                CKEDITOR.on("instanceReady", function (e) {
                    t.waypoint.context.refresh()
                })
            }
        }, _createStickyFooter: function () {
            var e = t(this.element);
            this.$placeholder.height(e.height()), e.addClass(this.settings.stickyClass).width(this.$placeholder.width())
        }, _refreshWaypointAndWidth: function () {
            this.waypoint.context.refresh(), t(this.element).width(this.$placeholder.width())
        ...
        return function () {
                ...
                !function (t) {
                    ...
                    function o(e, t) {
                        ...
                        if (e && "." === e.charAt(0)) if (t) {
                            for (e = e.split("/"), s = e.length - 1, y.nodeIdCompat && b.test(e[s]) && (e[s] = e[s].replace(b, "")), e = h.slice(0, h.length - 1).concat(e), u = 0; u < e.length; u += 1) if (p = e[u], "." === p) e.splice(u, 1), u -= 1; else if (".." === p) {
                    ...
                    var p, h, f, g, m = {}, v = {}, y = {}, w = {}, _ = Object.prototype.hasOwnProperty, $ = [].slice,
                        b = /\.js$/;
                    f = function (e, t) {
                        var n, i = u(e), r = i[0];
                        ...
                        if (o = o || e, "undefined" === $ || "function" === $) {
                            for (n = !n.length && i.length ? ["require", "exports", "module"] : n, h = 0; h < n.length; h += 1) if (p = f(n[h], o), u = p.f, "require" === u) _[h] = g.require(e); else if ("exports" === u) _[h] = g.exports(e), y = !0; else if ("module" === u) a = _[h] = g.module(e); else if (r(m, u) || r(v, u) || r(w, u)) _[h] = c(u); else {
            ...
            return t.Extend(n, t.Observable), n.prototype.render = function () {
                ...
                if (0 !== e.length) {
                    var t = this.$results.find("[aria-selected]"), n = t.index(e), i = this.$results.offset().top,
                        r = e.offset().top, o = this.$results.scrollTop() + (r - i), s = r - i;
            ...
            return n.prototype.bind = function (e, t, n) {
                ...
                var a = {height: this.$dropdown.outerHeight(!1)},
                    ...
                    u = l.bottom > o.bottom + a.height, d = {left: o.left, top: s.bottom};
            ...
            function t(t) {
                ...
                if (t = e.event.fix(s), t.type = "mousewheel", "detail" in s && (p = -1 * s.detail), "wheelDelta" in s && (p = s.wheelDelta), "wheelDeltaY" in s && (p = s.wheelDeltaY), "wheelDeltaX" in s && (d = -1 * s.wheelDeltaX), "axis" in s && s.axis === s.HORIZONTAL_AXIS && (d = -1 * p, p = 0), c = 0 === p ? d : p, "deltaY" in s && (p = -1 * s.deltaY, c = p), "deltaX" in s && (d = s.deltaX, 0 === p && (c = -1 * d)), 0 !== p || 0 !== d) {
                    ...
                    if (h = Math.max(Math.abs(p), Math.abs(d)), (!o || o > h) && (o = h, i(s, h) && (o /= 40)), i(s, h) && (c /= 40, d /= 40, p /= 40), c = Math[c >= 1 ? "floor" : "ceil"](c / o), d = Math[d >= 1 ? "floor" : "ceil"](d / o), p = Math[p >= 1 ? "floor" : "ceil"](p / o), u.settings.normalizeOffset && this.getBoundingClientRect) {
...
+function (t) {
    ...
    function e(e) {
        return this.each(function () {
            var s = t(this), i = s.data("bs.toggle"), n = "object" == typeof e && e;
            i || s.data("bs.toggle", i = new o(this, n)), "string" == typeof e && i[e] && i[e]()
        })
    }

    var o = function (e, o) {
        this.$element = t(e), this.options = t.extend({}, this.defaults(), o), this.render()
    };
    o.VERSION = "2.2.0", o.DEFAULTS = {
        on: "On",
        off: "Off",
        onstyle: "primary",
        offstyle: "default",
        ...
        return {
            on: this.$element.attr("data-on") || o.DEFAULTS.on,
            off: this.$element.attr("data-off") || o.DEFAULTS.off,
            onstyle: this.$element.attr("data-onstyle") || o.DEFAULTS.onstyle,
            offstyle: this.$element.attr("data-offstyle") || o.DEFAULTS.offstyle,
            size: this.$element.attr("data-size") || o.DEFAULTS.size,
            style: this.$element.attr("data-style") || o.DEFAULTS.style,
            width: this.$element.attr("data-width") || o.DEFAULTS.width,
            height: this.$element.attr("data-height") || o.DEFAULTS.height
        }
    }, o.prototype.render = function () {
        this._onstyle = "btn-" + this.options.onstyle, this._offstyle = "btn-" + this.options.offstyle;
        var e = "large" === this.options.size ? "btn-lg" : "small" === this.options.size ? "btn-sm" : "mini" === this.options.size ? "btn-xs" : "",
            o = t('<label class="btn">').html(this.options.on).addClass(this._onstyle + " " + e),
            s = t('<label class="btn">').html(this.options.off).addClass(this._offstyle + " " + e + " active"),
            i = t('<span class="toggle-handle btn btn-default">').addClass(e),
            n = t('<div class="toggle-group">').append(o, s, i),
            l = t('<div class="toggle btn" data-toggle="toggle">').addClass(this.$element.prop("checked") ? this._onstyle : this._offstyle + " off").addClass(e).addClass(this.options.style);
        this.$element.wrap(l), t.extend(this, {
            $toggle: this.$element.parent(),
            $toggleOn: o,
            $toggleOff: s,
            $toggleGroup: n
        }), this.$toggle.append(n);
        var h = this.options.width || Math.max(o.outerWidth(), s.outerWidth()) + i.outerWidth() / 2,
            a = this.options.height || Math.max(o.outerHeight(), s.outerHeight());
        o.addClass("toggle-on"), s.addClass("toggle-off"), this.$toggle.css({
            width: h,
            height: a
        }), this.options.height && (o.css("line-height", o.height() + "px"), s.css("line-height", s.height() + "px")), this.update(!0), this.trigger(!0)
    }, o.prototype.toggle = function () {
        this.$element.prop("checked") ? this.off() : this.on()
    }, o.prototype.on = function (t) {
        return this.$element.prop("disabled") ? !1 : (this.$toggle.removeClass(this._offstyle + " off").addClass(this._onstyle), this.$element.prop("checked", !0), void(t || this.trigger()))
    }, o.prototype.off = function (t) {
        return this.$element.prop("disabled") ? !1 : (this.$toggle.removeClass(this._onstyle).addClass(this._offstyle + " off"), this.$element.prop("checked", !1), void(t || this.trigger()))
    ...
    t.fn.bootstrapToggle = e, t.fn.bootstrapToggle.Constructor = o, t.fn.toggle.noConflict = function () {
        ...
        var o = t(this).find("input[type=checkbox]");
        o.bootstrapToggle("toggle"), e.preventDefault()
    })
}(jQuery);
jQuery.extend({
    ...
    var i = n.caseSensitive ? "" : "i", r = "(" + e.join("|") + ")";
    n.wordsOnly && (r = "\\b" + r + "\\b");
...
function createNullableControls() {
    var e = function () {
        var e = $(this);
        e.closest(".form-group").find("select").each(function () {
            var t = e.is(":checked");
            $(this).prop("disabled", t), t ? $(this).parent().slideUp({duration: 200}) : $(this).parent().slideDown({duration: 200})
        })
    };
    $(".nullable-control :checkbox").bind("change", e).each(e)
}

function toggleNavigation(e) {
    var t = "_easyadmin_navigation_iscollapsed";
    return function () {
        e ? createPersistentCookie(t, !0) : deleteCookie(t)
    }
}

function createPersistentCookie(e, t) {
    document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + "; path=/; expires=Fri, 31 Dec 9999 23:59:59 GMT"
}

function deleteCookie(e) {
    document.cookie = encodeURIComponent(e) + "=; path=/; expires=Thu, 01 Jan 1970 00:00:00 GMT"
}

function createAutoCompleteFields() {
    var e = $("[data-easyadmin-autocomplete-url]");
    e.each(function () {
        var e = $(this), t = e.data("easyadmin-autocomplete-url");
        e.select2({
            theme: "bootstrap", ajax: {
                url: t, dataType: "json", delay: 250, data: function (e) {
                    return {query: e.term, page: e.page}
                }, processResults: function (e, t) {
                    return {results: e.results, pagination: {more: e.has_next_page}}
                }, cache: !0
            }, placeholder: "", allowClear: !0, minimumInputLength: 1
        })
    })
}
...
$(function () {
    var e = $("body");
    e.on("expanded.pushMenu", toggleNavigation(!1)).on("collapsed.pushMenu", toggleNavigation(!0)), createNullableControls(), createAutoCompleteFields()
});
